  ...
  return (
    <footer className="bg-gradient-to-b from-white to-blue-200 text-black pt-6 sm:pt-8 lg:pt-12">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        {/* ส่วนหลักของ Footer */}
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-5 lg:gap-6">
          {/* โลโก้และชื่อคลินิก */}
          ...
          {/* เมนู Link และ Social Media - ให้มี flex เท่ากัน */}
          <div className="text-center md:text-left lg:col-span-2 flex flex-col lg:flex-row gap-6 lg:gap-8">
            {/* เมนู Link */}
