...
export default function CosmeticDentistryPage() {
  const serviceDetail = serviceDetails["cosmetic-dentistry"];
            ...
            {serviceDetail.types.items.map((type, index) => (
              ...
              >
                ...
                <p className="text-xs my-1">
                  <span className="font-medium">ลักษณะ:</span>{" "}
                  {type.description}
                </p>
                <p className="text-xs my-1">
                  <span className="font-medium">ข้อดี:</span>
                </p>
                ...
                {type.disadvantages && type.disadvantages.length > 0 && (
                  <>
                    <p className="text-xs my-1">
                      <span className="font-medium">ข้อเสีย:</span>
                    </p>
                    <ul className="list-disc pl-5 text-xs">
